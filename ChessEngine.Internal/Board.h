...
namespace ChessEngine
{
    ...
    private:
        ...
        // NOTE:
        // We need to update the Zobrist hash as we update the board's state. These helper functions
        // below do this so should be used to update the board's state rather than doing so directly.
